...
class UserAPI implements IUserAPI {
  ...
  Future<List<Document>> searchUserByName(String name) async {
    final dcouments = await _db.listDocuments(
      databaseId: AppwriteConstants.databaseId,
      collectionId: AppwriteConstants.usersCollection,
      queries: [Query.search('name', name)],
    );
    return dcouments.documents;
  }
  ...
  Stream<RealtimeMessage> getLatestUserProfileData() {
    ...
    [
        'databases.${AppwriteConstants.databaseId}.collections.${AppwriteConstants.usersCollection}.documents.*.update',
     ]
    ).stream;
  }
